<?php
  include 'koneksi.php';
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($id_transaksi) || empty($tanggal) || empty($id_barang) || empty($nama_barang) || empty($jumlah_masuk)) {
            ...
            if (mysqli_num_rows($stok_result) > 0) {
                ...
                $jumlah_stok_baru = $jumlah_stok_sekarang + $jumlah_masuk;
                ...
                if ($update_result) {
                    ...
                    $sql = "INSERT INTO barang_masuk (id_transaksi, tanggal, id_barang, nama_barang, jumlah_masuk) VALUES ('$id_transaksi', '$tanggal', '$id_barang', '$nama_barang', '$jumlah_masuk')";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="side-nav">
      ...
      <a href="barang_masuk.php" style="background-color: white; color: #3c2bad">Barang Masuk</a>
        ...
        <div class="content">
            <div class="tambah-akun">
                <form action="tambah_barang_masuk.php" method="post">
                    ...
                    <input type="date" id="id" name="tanggal_masuk" required>
                    ...
                    <input type="number" id="jumlah_masuk" name="jumlah_masuk" required>
