...
<html lang="en">
  ...
  <body>
    ...
    <div class="side-nav">
      <a href="dashboard_staff_gudang.php" style="background-color: white; color: #3c2bad">Dashboard</a>
    ...
    <div class="main-dashboard">
        ...
        <div class="content">
          ...
          <a href="stok_barang.php" class="more-info-satu">More info</a>
          </div>
          ...
          <a href="barang_masuk.php" class="more-info-satu">More info</a>
          </div>
          ...
          <a href="barang_keluar.php" class="more-info-satu">More info</a>
          </div>
        </div>
    </div>
