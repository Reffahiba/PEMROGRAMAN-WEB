<?php
  include 'koneksi.php';
    ...
    $offset = ($page - 1) * $limit;
    $query = "SELECT * FROM barang_keluar LIMIT $limit OFFSET $offset";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-container">
      <div class="main-data">
          <div class="head">Barang Keluar</div>
          <hr />
          <div class="content">
            <nav class="navbar">
              <input type="text" placeholder="Search..." class="search-bar" name="search" />
              <a href="tambah_barang_keluar.php" class="tambah-data">+ Tambah Data</a>
            </nav>
          </div>
              ...
              <?php
                ...
                // Loop melalui setiap baris hasil kueri dan tampilkan data dalam baris tabel
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><button class='hapus-btn' data-id='" . $row['id_transaksi'] . "' onclick=\"showConfirmation('" . $row['id_transaksi'] . "')\">Hapus</a></button></td>";
                    echo "</tr>";
                    $nomor++;
                  }
                ?>
          ...
          <div id="confirmationPopup" class="popup" style="display: none">
              <div class="popup-content">
                  ...
                  <p class="popup-message">APAKAH ANDA YAKIN INGIN MENGHAPUS TRANSAKSI KELUAR?</p>
                  <div class="popup-btn">
          ...
          <script>
              function showConfirmation(userId){
                ...
                confirmBtn.onclick = function(){
                  window.location.href = 'hapus_transaksi_keluar.php?id=' + userId;
                };
