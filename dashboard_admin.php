<?php
  ...
  // Buat kueri SQL untuk memeriksa keberadaan username di dalam tabel pengguna
    $check_query = "SELECT COUNT(*) AS jumlah_pengguna FROM pengguna";

    // Eksekusi kueri SQL
    $result = mysqli_query($conn, $check_query);
    $row = mysqli_fetch_assoc($result);

    // Menyimpan jumlah baris dalam variabel untuk digunakan di elemen <h2>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="side-nav">
      <a href="dashboard_admin.php" style="background-color: white; color: #3c2bad">Dashboard</a>
    ...
    <div class="main-dashboard">
        ...
        <div class="content">
          <div class="kotak-satu">
            <div class="wrapper">
              <div>
                <h1 class="text"><?php echo $jumlah_pengguna; ?></h1>
                <h4 class="text">Pengguna</h4>
              </div>
              <div>
                <img src="gambar/user.png" alt="gambar" width="20%" height="20%" class="logo-kotak">
              </div>
            </div>
          <a href="kelola_user.php" class="more-info-satu">More info</a>
          </div>
        </div>
    </div>
